    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('last_update_date', models.DateField(blank=True, null=True, verbose_name='Посл дата обновления')),
                ('next_payment_date', models.DateField(blank=True, null=True, verbose_name='След дата платежа')),
                ('last_date_of_payment', models.DateField(blank=True, null=True, verbose_name='Посл дата платежа')),
                ('date_of_restructuring', models.DateField(blank=True, null=True, verbose_name='Дата реструктуризации')),
                ('expected_closing_date', models.DateField(blank=True, null=True, verbose_name='Ожидаемая дата закрытия')),
                ('actual_closing_date', models.DateField(blank=True, null=True, verbose_name='Действительная дата закрытия')),
                ('main_amount_owed', models.DecimalField(decimal_places=2, max_digits=10, verbose_name='Осн сумма задолженности')),
                ('monthly_payment', models.CharField(blank=True, max_length=128, null=True, verbose_name='Ежемесечная выплата')),
                ('amount_of_credit', models.DecimalField(blank=True, decimal_places=2, max_digits=10, null=True, verbose_name='Сумма кредита')),
                ('total_amount', models.DecimalField(blank=True, decimal_places=2, max_digits=10, null=True, verbose_name='Общ сумма')),
                ('payment_amount', models.DecimalField(blank=True, decimal_places=2, max_digits=10, null=True, verbose_name='Сумма платежа')),
                ('frequency_of_payments', models.CharField(blank=True, max_length=64, null=True, verbose_name='Периодичность платежей')),
                ('count_of_payments', models.IntegerField(blank=True, null=True, verbose_name='кол-во платежей')),
                ('payment_intervals', models.CharField(blank=True, max_length=128, null=True, verbose_name='Периодичность платежей')),
                ('amount_written_off', models.DecimalField(blank=True, decimal_places=2, max_digits=10, null=True, verbose_name='Списанная сумма')),
                ('amount_of_prolongation', models.DecimalField(blank=True, decimal_places=2, max_digits=10, null=True, verbose_name='Сумма пролонгации')),
                ('amount_of_additional_fees', models.DecimalField(blank=True, decimal_places=2, max_digits=10, null=True, verbose_name='Сумма доп сборов')),
                ('additional_fees_written_off', models.DecimalField(blank=True, decimal_places=2, max_digits=10, null=True, verbose_name='Списанные доп сборы')),
                ('interest_deducted_amount', models.DecimalField(blank=True, decimal_places=2, max_digits=10, null=True, verbose_name='Списанная сумма по процентам')),
                ('prolongation_date', models.DateField(blank=True, null=True, verbose_name='дата пролонгации')),
                ('number_of_payments', models.IntegerField(blank=True, null=True, verbose_name='Кол-во платежей')),
                ('amount_of_delay', models.DecimalField(blank=True, decimal_places=2, max_digits=10, null=True, verbose_name='Сумма просрочки')),
                ('overdue_interest', models.DecimalField(blank=True, decimal_places=2, max_digits=10, null=True, verbose_name='просроченные проценты')),
                ('number_of_days_overdue', models.IntegerField(blank=True, null=True, verbose_name='Кол-во дней просрочек')),
                ('number_of_payments_in_arrears', models.IntegerField(blank=True, null=True, verbose_name='Кол-во платежей в просрочке ')),
                ...
                ('calendar', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='loans_calendar', to='loan.repayment_schedule')),
            ],
            options={
                'verbose_name': 'Кредит',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('result', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='Inqueries', to='loan.result')),
            ],
            options={
                'verbose_name': 'Запрос',
