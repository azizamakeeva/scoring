# Generated by Django 4.1.7 on 2023-04-19 12:40
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('loan_history_cb', '0001_initial'),
        ('loan', '0002_alter_bail_options_alter_bail_type_options_and_more'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('loan_history', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='client_lh', to='loan.loan_history')),
                ('loan_history_cb', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='client_lh_cb', to='loan_history_cb.loan_history_cb')),
            ],
            options={
                'verbose_name': 'Клиент',
